...
$sql = "UPDATE callcenter SET rtecno = '$rtecno', sumadown = '$UpTime', SR = '$sr', fevento = '$fevento', fint = '$fint', registro = '$registro', estatus = 'Finalizado', actividades ='$actividades' WHERE id = '$id'";
